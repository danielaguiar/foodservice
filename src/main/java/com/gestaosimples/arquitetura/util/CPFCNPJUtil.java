...
public class CPFCNPJUtil {
    ...
    public static boolean isCpf(final String nrCpfCnpj) {
        return nrCpfCnpj.length() == 11;
    }

    public static boolean isCnpj(final String nrCpfCnpj) {
        return nrCpfCnpj.length() == 14;
    }

    public static boolean isValidarCpfCnpj(final String nrCpfCnpj) {
        if (nrCpfCnpj.length() > 11) {
            return isValidCNPJ(nrCpfCnpj);
        } else {
            return isValidCPF(nrCpfCnpj);
        }
    }
}